...
public class SearchListAdpter extends RecyclerView.Adapter<SearchListAdpter.ViewHolder> {
    private final OnItemClickListener listener;
    private ArrayList<String> listData;
    private Context context;

    public SearchListAdpter(Context context, ArrayList<String> notificationModelArrayList, OnItemClickListener listener) {

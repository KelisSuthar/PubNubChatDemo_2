...
public class ListAddData implements Parcelable
{
...
public final static Parcelable.Creator<ListAddData> CREATOR = new Creator<ListAddData>() {


@SuppressWarnings({
"unchecked"
})
public ListAddData createFromParcel(Parcel in) {
return new ListAddData(in);
}

public ListAddData[] newArray(int size) {
return (new ListAddData[size]);
}

}
;

protected ListAddData(Parcel in) {
...
* @param updatedAt
*/
public ListAddData(Integer customerAddressID, Integer customerID, String adderessType, String adderessCity, String adderess, String adderessLatitude, String adderessLongitude, String defaultType, String status, String createdAt, String updatedAt) {
super();
